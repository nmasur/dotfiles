                ...
                panels = [
                    ...
                    targets = [
                      {
                        ...
                        exemplar = false;
                        "expr" =
                          ''increase(zfs_dataset_used_bytes{name="tank"}[1d])'';
                        hide = false;
                        instant = false;
                        interval = "";
                      ...
                      }
                      {
                        ...
                        editorMode = "code";
                        "expr" =
                          ''increase(zfs_dataset_used_bytes{name="tank"}[7d])'';
                        hide = false;
                          ...
                          properties = [
                            ...
                            }
                            {
                              ...
                              value = [{
                                ...
                                title = "";
                                url =
                                  "https://${config.hostnames.download}/bazarr";
                              }];
                            }
                          ];
                        }
                          ...
                          properties = [
                            ...
                            }
                            {
                              ...
                              value = [{
                                ...
                                title = "";
                                url =
                                  "https://${config.hostnames.download}/radarr";
                              }];
                            }
                          ];
                        }
                          ...
                          properties = [
                            ...
                            }
                            {
                              ...
                              value = [{
                                ...
                                title = "";
                                url =
                                  "https://${config.hostnames.download}/sabnzbd";
                              }];
                            }
                          ];
                        }
                          ...
                          properties = [
                            ...
                            }
                            {
                              ...
                              value = [{
                                ...
                                title = "";
                                url =
                                  "https://${config.hostnames.download}/sonarr";
                              }];
                            }
                          ];
                        }
                          ...
                          properties = [
                            ...
                            }
                            {
                              ...
                              value = [{
                                ...
                                title = "";
                                url =
                                  "https://${config.hostnames.download}/prowlarr";
                              }];
                            }
                          ];
                        }
                          ...
                          properties = [
                            ...
                            }
                            {
                              ...
                              value = [{
                                ...
                                title = "";
                                url =
                                  "https://${config.hostnames.prometheus}/vmui";
                              }];
                            }
                          ];
                        }
                  ...
                  # Memory by Host
                  {
                    ...
                    targets = [{
                      ...
                      exemplar = false;
                      "expr" =
                        "sort_desc(node_memory_Active_bytes/node_memory_MemTotal_bytes)";
                      instant = true;
                      legendFormat = "{{job}}";
                      range = false;
                      refId = "A";
